...
/* comment include and uncomment if file is not present */
...
static const char *fonts[]          = {"monospace:size=11","NotoColorEmoji:pixelsize=11:antialias=true:autohint=true"};
...
static const Key keys[] = {
	...
	/* { ALT,                          XK_q,      spawn,          SHCMD("killall -HUP $( xdotool getwindowfocus getwindowname )")}, */
	...
	{ ALT,                          XK_k,      spawn,          SHCMD("[ -n $( pgrep picom ) ] && killall picom || picom -b")},
	{ ALT,                          XK_u,      spawn,          SHCMD("st -e paru -Syu --skipreview --needed")},
	{ MODKEY,                       XK_minus,  spawn,          SHCMD("pamixer -d 1; kill -35 $(pidof dwmblocks)")},
	{ ALT,                          XK_minus,  spawn,          SHCMD("pamixer -d 2; kill -35 $(pidof dwmblocks)")},
	{ MODKEY,                       XK_equal,  spawn,          SHCMD("pamixer -i 1; kill -35 $(pidof dwmblocks)")},
	{ ALT,                          XK_equal,  spawn,          SHCMD("pamixer -i 2; kill -35 $(pidof dwmblocks)")},
